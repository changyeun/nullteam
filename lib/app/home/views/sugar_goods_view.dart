...
class SugarGoodsView extends GetView<HomeController> {
  SugarGoodsView({super.key});
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        child: Text('건강 추천 패키지', style: TextStyle(fontSize: 20, color: Colors.black, fontWeight: FontWeight.bold)),
                      ),
                      IconButton(
                        onPressed: () async {
                          // Get.back();
                          ...
                          Container(
                            ...
                            child: Wrap(
                                children: List.generate(
                                  controller.sugarCartList.length,
                                      (index) => Row(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                                      Text('${index+1}. ${controller.sugarCartList[index]}',
